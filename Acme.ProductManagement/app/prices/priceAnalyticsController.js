...
(function () {
    angular.module("productManagement")
        .controller("PriceAnalyticsController", ["$scope", "$filter", "products", "productService", function ($scope, $filter, products, productService) {
            ...
            //$filter is built in filtering service 
            var orderedProductsAmount = $filter("orderBy")(products, "marginAmount");
            //we have first ordered the items and then taken first 5 items
            ...
            //This configuration is about look and feel of the chart
            $scope.configAmount = {
